...
public class XIncluder {
    ...
    public Document perform(Document doc, Variables context, boolean ignoreProperties) throws Exception {
        ...
        for (Element include : includeElements) {
            ...
            if (file != null) {
                ...
                if (f.canRead()) {
                    ...
                    log.debug("No file found for {}, checking classpath...", file);
                    if (!file.startsWith("/"))
                        file = "/" + file;
            ...
            if (included == null) {
                ...
                if (optional.equalsIgnoreCase("true"))
                    ...
                    log.error("Failed to include document for include tag with attributes {}",
            ...
            NodeList includeList = included.getDocumentElement().getChildNodes();
            ...
            if (includeList.getLength() == 0) {
                ...
                //
                Element subTree = (Element) doc.importNode(included.getDocumentElement(), true);
