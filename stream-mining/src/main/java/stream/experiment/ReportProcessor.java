...
public class ReportProcessor extends VariableContext {
	...
	public static void copyResource(String uri, OutputStream out)
			throws Exception {
		URL url = ReportProcessor.class.getResource(uri);
		if (url == null) {
			log.error("Resource '{}' not found!", uri);
	...
	public static void main(String[] args) throws Exception {
		File in = new File(
				"/Users/chris/Documents/jwall.org/AuditConsole/console-reporting/output/report.db");
		File out = new File(
				"/Users/chris/Documents/jwall.org/AuditConsole/console-reporting/output/report.db.postprocessed");
