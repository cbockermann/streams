 ...
 * 
 */
public class EqualsRXCondition extends OperatorCondition<String> {

	private final Pattern pattern;

	public EqualsRXCondition(Expression<String> left, Expression<String> right) {
		super(left, right, "@rx s");
