...
public class GKQuantiles extends DeterministicQuantileEstimator {
	...
	private boolean initialPhase; // GK needs 1 / (2 * epsilon) elements to
	...
	public QuantileModel getModel() {
		final GKQuantiles gk = this;
		return new QuantileModel(getId()) {
			/** The unique class ID */
			private static final long serialVersionUID = -5998648852860296174L;

			@Override
			public Double getQuantile(Double phi) {
				return gk.getQuantile(phi);
			}
		};
	}
