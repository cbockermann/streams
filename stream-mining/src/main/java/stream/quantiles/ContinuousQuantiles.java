 ...
 * 
 */
public class ContinuousQuantiles extends AbstractQuantileLearner {
	...
	public QuantileModel getModel() {
		...
		return new QuantileModel(getId()) {
			...
			/** The unique class ID */
			private static final long serialVersionUID = 1282997471121794500L;
