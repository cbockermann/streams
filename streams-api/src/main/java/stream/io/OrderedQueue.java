 ...
 * 
 */
public class OrderedQueue implements Queue<Data> {
    ...
    public boolean write(Data item) throws Exception {
        ...
        synchronized (lock) {
            ...
            try {
                ...
                log.error("Failed to determine sequence ID from item at key '{}': {}", sequenceKey, e.getMessage());
    ...
    public Data read() throws Exception {
        ...
        synchronized (lock) {
            ...
            if (closed && nextItem == null && this.queue.isEmpty())
                return null;
