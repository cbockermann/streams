...
public class WindowSketchQuantiles extends DeterministicQuantileEstimator {
	...
	public QuantileModel getModel() {
		final WindowSketchQuantiles wsq = this;
	...
	public Double getQuantile(double phi) {
		...
		// LinkedList<ComparableWrapper<Double, Float>> sortedSummary =
		// this.getOrderedSummary();
		...
		/*
		 * Double border = this.getBorderElement(phi,
		 * (LinkedList<ComparableWrapper<Double,Float>>) sortedSummary.clone());
	...
	private LinkedList<Double> getFinalSummary() {
		...
		for (int i = 0; i < summary.size(); i++) {
			...
			Float weight = this.computeLevelForEpsilon(summary.get(i)
					.getEpsilon());
