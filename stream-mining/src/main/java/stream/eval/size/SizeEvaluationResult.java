...
/**
 * <p>
 * By passing an identifier and a learner instance into an instance of this
 * class the sizes of the learner and its model will be determined.
 * </p>
 * 
...
public class SizeEvaluationResult implements Serializable {
	...
	/**
	 * <p>
	 * Creates a new instance of this result class.
	 * </p>
	 * 
	 * @param identifier
	 *            The string which identifies the field of the node where the
	 *            provided learner came from
	 * @param learner
	 *            The learner instance to get model and learner size from
	 */
	...
	/**
	 * Returns a string which should identify the field of the node where the
	 * provided learner came from
	 * 
	 * @return a string which should identify the field of the node where the
	 *         provided learner came from
	 */
	...
	public String toString() {
		...
		return new StringBuilder(lineSeparator).append("SizeEvaluation for ")
				.append(identifier).append(":").append(lineSeparator)
				.append("Learner: ").append(learnerSize).append(" bytes")
				.append(lineSeparator).append("Model:   ").append(modelSize)
