...
/**
 * The data stream oracle is a simple data processor that is based upon a
 * learner (a learner needs to be provided) and simply adds the prediction of
 * this learner to all data items that have been presented to the processor.
 * 
 * @author Christian Bockermann &lt;chris@jwall.org&gt;
 * 
 */
public class DataStreamOracle extends AbstractDataProcessor {
