...
public class DefaultLookupService implements LookupService {
	...
	/**
	 * @see stream.logic.LookupService#lookup(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see stream.logic.LookupService#register(java.lang.String,
	...
	/**
	 * @see stream.logic.LookupService#unregister(java.lang.String)
	 */
	@Override
