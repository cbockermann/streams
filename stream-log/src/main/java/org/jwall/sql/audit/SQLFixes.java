...
/**
 * This class implements some preprocessing of SQL query string to allow for the
 * JSQL-based stream-parser to properly parse more kinky SQL expressions...
 * 
 * @author Christian Bockermann &lt;chris@jwall.org&gt;
 * 
 */
public class SQLFixes extends AbstractDataProcessor {
