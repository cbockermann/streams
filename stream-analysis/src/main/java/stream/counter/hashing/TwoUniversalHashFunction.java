 ...
 * 'Universal classes of hash functions' written by 'Carter, J. L. and Wegman,
 * M. N. (1977)'.
 * </p>
 * 
 ...
 * @param <T>
 */
public class TwoUniversalHashFunction<T> implements HashFunction<T>,
		Serializable {
	...
	public TwoUniversalHashFunction(int domain, int coDomain) {
		...
		this.a = aTemp;
		this.b = -this.prime
				+ (int) (Math.random() * ((this.prime + this.prime) + 1));
