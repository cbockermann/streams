...
public class DataStreamFactory {
	...
	public static DataStreamWriter createDataOutputStream(String format,
		...
		if (format != null && "sparse".equalsIgnoreCase(format.trim()))
			return new SparseDataWriter(out);

		return new SparseDataWriter(out);
	}

	public static DataStream createDataInputStream(String format, InputStream in)
			throws Exception {
