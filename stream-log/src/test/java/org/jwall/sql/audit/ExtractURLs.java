...
public class ExtractURLs {
	...
	public static void main(String[] args) throws Exception {
		AbstractDataStream stream = new LogDataStream(new URL(
				"file:/Users/chris/shop-access.log"));

		stream = new ModSecurityAuditStream(new URL(
				"file:/Users/chris/shop-audit.log"));
		...
		// stream.addPreprocessor( new DateParser( "DATE",
		// "[dd/MMM/yyyy:HH:mm:ss Z]" ) );
		stream.addPreprocessor(new AbstractDataProcessor() {
			@Override
