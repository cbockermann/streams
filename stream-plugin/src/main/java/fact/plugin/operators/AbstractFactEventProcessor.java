...
public abstract class AbstractFactEventProcessor extends Operator implements
	...
	final InputPort input = getInputPorts().createPort("evt",
			FactEventObject.class); // .createPort( "evt" );
	 ...
	 * @param description
	 */
	public AbstractFactEventProcessor(OperatorDescription description,
			Class<?> clazz) {
		super(description);
