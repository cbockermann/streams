...
/**
 * This class reads a CSV file and writes CSV file. It will pass through the
 * input file twice to determine the complete list of columns and then starts to
 * write out the fully, non-sparse items.
 * 
