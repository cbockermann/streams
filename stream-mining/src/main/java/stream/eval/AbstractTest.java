...
/**
 * <p>
 * This class implements an abstract test of a set of learners. The test is
 * carried out on some specified test datum.
 * </p>
 * 
 * @author Christian Bockermann &lt;chris@jwall.org&gt;
 * 
 * @param <D>
 *            The generic type of data that the learners can be tested upon.
 * @param <L>
 *            The learner type. All learners need to reflect a common generic
 *            type.
 */
public abstract class AbstractTest<L extends Learner<?>> implements
		Evaluation<L>, Test<L> {
