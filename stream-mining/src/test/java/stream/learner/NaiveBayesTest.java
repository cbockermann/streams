...
public class NaiveBayesTest {
	...
	/**
	 * Test method for
	 * {@link stream.learner.NaiveBayes#predict(stream.data.Data)}.
	 */
	@Test
	...
	public void testLearn() throws Exception {
		...
		DataStream stream = ds.createDataStream(); // new CsvStream(
													// NaiveBayesTest.class.getResource(
													// "/golf.csv" ) );
		Data first = null;
		...
		String prediction = nb.classify(test);
		log.info("item is: {}", test);
		log.info("Prediction is: {}", prediction);
		log.info("real label is: {}", test.get("play"));
