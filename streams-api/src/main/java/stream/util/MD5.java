 ...
 * and computes the md5 hex-string of a given input string. It is basically just
 * a wrapper and uses the MessageDigest class of the Java runtime library.
 * 
...
public class MD5 {
	 ...
	 * 
	 * @param message
	 *            The message to create the digest from.
